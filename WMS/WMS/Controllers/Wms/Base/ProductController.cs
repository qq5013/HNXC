...
namespace WMS.Controllers.Wms.Base
{
    ...
    public class ProductController : Controller
    {
        ...
        // GET: /Product/Details/
        public ActionResult Details(int page, int rows, string productselectstr,string formula, FormCollection collection)
        {
            ...
            //string productcodestr =Request .QueryString [""].ToString ()
            if (print == "1")
            {
            ...
            var Products = ProductService.GetDetails(page, rows, PRODUCT_NAME, ORIGINAL, YEARS, GRADE, STYLE, WEIGHT, MEMO, CATEGORY_CODE, productselectstr, formula);
