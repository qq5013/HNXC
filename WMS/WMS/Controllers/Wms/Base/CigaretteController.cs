...
namespace WMS.Controllers.Wms.Base
{
    ...
    public class CigaretteController : Controller
    {
        ...
        // POST: /Cigarette/Edit/
        [HttpPost]
        public ActionResult Edit(string CIGARETTE_CODE, string CIGARETTE_NAME, string CIGARETTE_MEMO, string MES_STATUS)
        {
            bool bResult = CigaretteService.Save(CIGARETTE_CODE, CIGARETTE_NAME, CIGARETTE_MEMO,MES_STATUS );
