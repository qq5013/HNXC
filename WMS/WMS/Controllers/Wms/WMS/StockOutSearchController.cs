...
namespace WMS.Controllers.Wms.WMS
{
    ...
    public class StockOutSearchController : Controller
    {
        ...
        public ActionResult Details(int page, int rows, string flag, FormCollection collection)
        {
            ...
            string HFIRST_DATE = collection["HFIRST_DATE"] ?? "";
            string HLAST_DATE = collection["HLAST_DATE"] ?? "";
            string TFIRST_DATE = collection["TFIRST_DATE"] ?? "";
            string TLAST_DATE = collection["TLAST_DATE"] ?? ""; 
