...
namespace WMS.Controllers.Wms.WMS
{
    ...
    public class StockInBillController : Controller
    {
        ...
        //批次入库时,载入配方.
        public ActionResult LoadFormula(int page, int rows, string Formulacode, decimal BATCH_WEIGHT, string module)
        {
            var Billdetail = BillMasterService.LoadFormulaDetail(page, rows, Formulacode, BATCH_WEIGHT,module.Trim ()); 
