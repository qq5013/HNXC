...
namespace WMS.Controllers.Wms.WMS
{
    ...
    public class WorkSearchController : Controller
    {
        ...
        public ActionResult Details(int page, int rows, FormCollection collection)
        {
            ...
            string FINISH_DATE = collection["FINISH_DATE"] ?? ""; //作业完成时间
            ...
            var worksearch = ProductStateService.Worksearch(page, rows, BILL_NO, TASK_DATE, BTYPE_CODE, TASK_NO, CIGARETTE_CODE, FORMULA_CODE, PRODUCT_BARCODE, FINISH_DATE);
