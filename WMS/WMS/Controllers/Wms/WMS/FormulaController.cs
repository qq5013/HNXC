...
namespace WMS.Controllers.Wms.WMS
{
    ...
    public class FormulaController : Controller
    {
        ...
        // POST: /Formula/Create/
        [HttpPost]
        public ActionResult Create(WMS_FORMULA_MASTER master)
        {
        ...
        // POST: /Formula/Create/
        [HttpPost]
        public ActionResult Edit(WMS_FORMULA_MASTER master)
        {
            object detail = Request.Params["detailjson"];
        ...
        //获取模块号
        public ActionResult Getmodules(string formulacode) {
            var modules = FormulaService.Getmodules(formulacode);
