...
{
    public class WMS_BILL_MASTERHMap : EntityTypeConfiguration<WMS_BILL_MASTERH>
    {
        public WMS_BILL_MASTERHMap()
        {
            // Primary Key
            ...
            this.ToTable("WMS_BILL_MASTERH","HNXC");
