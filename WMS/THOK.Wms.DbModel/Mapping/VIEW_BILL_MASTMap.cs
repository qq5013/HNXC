...
{
    public class VIEW_BILL_MASTMap : EntityTypeConfiguration<VIEW_BILL_MAST>
    {
        public VIEW_BILL_MASTMap()
        {
            // Primary Key
            ...
            this.ToTable("VIEW_BILL_MAST", "HNXC");
