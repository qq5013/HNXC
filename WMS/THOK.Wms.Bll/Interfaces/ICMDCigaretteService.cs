...
namespace THOK.Wms.Bll.Interfaces
{
    public interface ICMDCigaretteService: IService<CMD_CIGARETTE>
    {
        ...
        object GetDetailsD(int page, int rows, string CIGARETTE_NAME, string CIGARETTE_MEMO);

        bool Add(string CIGARETTE_NAME, string CIGARETTE_MEMO);

        bool Delete(string Cigarette_Code);

        bool Save(string CIGARETTE_CODE, string CIGARETTE_NAME, string CIGARETTE_MEMO, string MES_STATUS);
    }
}
