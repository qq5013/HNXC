...
namespace THOK.Wms.Bll.Interfaces
{
    ...
    {
        object GetDetails(int page, int rows, string ProductName, string ORIGINAL, string YEARS, string GRADE, string STYLE, string WEIGHT, string MEMO, string CATEGORY_CODE, string productcodestr, string formula);
