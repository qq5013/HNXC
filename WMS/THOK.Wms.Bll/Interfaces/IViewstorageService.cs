...
namespace THOK.Wms.Bll.Interfaces
{
    public interface IViewstorageService : IService<VIEW_STORAGE >
    {
        ...
        //货物仓库中的货物信息
        //object GetProductdetail(int page, int rows, string formula,string grade,string original,string billno);
        object GetProductdetail(int page, int rows, string formula, string productcode);
        object GetProductdetail2(int page, int rows, string queryinfo, string billno);
