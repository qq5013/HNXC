...
namespace THOK.Wms.Bll.Service
{
    class OutInSearchService : ServiceBase<VIEW_CMD_PRODUCT>, IOutInSearchService
    {
        ...
        public object GetDetails(int page, int rows, string BILL_NO, string IN_DATE)
        {
            ...
            var s = storagequery.ToArray().Select(i => new
            {
                i.GRADE_CODE,
                i.GRADE_NAME,
                i.ENGLISH_CODE,
            ...
            var storage = from a in s
                          group a by new { a.GRADE_CODE, a.GRADE_NAME, a.ENGLISH_CODE, a.USER_CODE, a.ORIGINAL_CODE, a.ORIGINAL_NAME, a.YEARS, a.MEMO, a.IN_DATE } into g
                          select new
                          {
                              g.Key.GRADE_CODE,
                              g.Key.GRADE_NAME,
